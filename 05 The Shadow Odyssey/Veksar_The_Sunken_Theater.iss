;================================================================================
; Title: Veksar: The Sunken Theater | Author: Unknown, The Marty Party | Date: 12 Feb 2024 | Version: 1.1
;================================================================================
...
objectdef Object_Instance
{
	...
	{        
		...
		if ${_StartingPoint} == 7
		{
			...
			Obj_OgreIH:ChangeCampSpot["23.906219,-3.991555,0.039273"]
		...
		wait 200
		Obj_OgreIH:SetCampSpot
		Obj_OgreIH:ChangeCampSpot["633.195435,-183.635925,290.366943"]
	...
	{
        echo ${Time}: Moving to Ul'lugh the Divine
        Obj_OgreIH:SetCampSpot
		Obj_OgreIH:ChangeCampSpot["-0.206306,-3.929445,-0.216120"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["1.750553,0.766725,-27.764765"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["27.752436,-0.664434,-27.278984"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["26.597778,1.660368,-56.155937"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["25.690805,3.386666,-86.120743"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["40.896408,3.461453,-85.407684"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["26.505890,3.386666,-85.311691"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["26.849834,1.660368,-56.161098"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["41.125118,2.352704,-56.355965"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
	...
	{
        echo ${Time}: Moving to Gruerg the Ravager
        Obj_OgreIH:ChangeCampSpot["25.773020,1.660368,-57.007988"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["25.582394,3.386666,-85.907021"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["26.556128,6.020567,-118.285072"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["48.198521,6.014326,-121.560875"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["65.458557,6.328431,-121.339714"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["65.654282,6.014326,-94.917458"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["98.172371,5.983990,-95.572296"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
	...
	{	
        echo ${Time}: Moving to Boss Riggledub
        ...
        Obj_OgreIH:ChangeCampSpot["36.515079,6.014326,-121.370743"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["36.957115,6.014326,-143.800186"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["63.837364,6.014326,-144.710175"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

    	Obj_OgreIH:ChangeCampSpot["63.514088,6.014326,-170.989075"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["64.034485,6.014326,-199.107361"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["31.653305,6.014326,-199.091232"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["64.486633,6.014326,-199.428162"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["63.839142,6.014326,-171.960922"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["68.840889,6.014326,-171.627197"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        echo ${Time}: Targeting Boss Riggledub
	...
	{
        echo ${Time}: Moving to Cribblekeep
        Obj_OgreIH:SetCampSpot

		Obj_OgreIH:ChangeCampSpot["63.911945,6.014326,-172.087418"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["63.816544,6.014326,-210.024567"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["66.310837,6.014326,-229.060501"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["31.277302,6.014320,-226.789719"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10

		Obj_OgreIH:ChangeCampSpot["8.616286,-1.110678,-227.083878"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

        Obj_OgreIH:ChangeCampSpot["8.296995,-0.610674,-199.016739"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["-16.072323,-0.610680,-201.661804"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-22.613546,-0.610677,-183.175278"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
	...
	{
        echo ${Time}: Moving to Lord Sasil
        Obj_OgreIH:SetCampSpot
		...
		Obj_OgreIH:ChangeCampSpot["-22.563339,-0.610677,-183.986954"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
		wait 10

		Obj_OgreIH:ChangeCampSpot["-15.242858,-0.610680,-201.738358"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-22.813227,-0.485674,-182.058609"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
		wait 10

		Obj_OgreIH:ChangeCampSpot["-22.576735, -2.907978, -151.271423"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["-11.791109,-3.485674,-144.441956"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-5.281072,-3.485674,-143.881149"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["-11.947193,-3.235674,-133.167206"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-10.907357,-3.235674,-112.177032"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["-42.351986,-3.235679,-111.768600"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat 30
		eq2execute summon
		wait 10
		
		call Obj_OgreUtilities.PreCombatBuff 5

		Obj_OgreIH:ChangeCampSpot["-72.161636,-1.860673,-112.056702"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["-105.233986,-1.860660,-111.621910"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		;Destroying wall
        Obj_OgreIH:ChangeCampSpot["-124.016075,-1.860660,-108.384819"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		wait 10
		...
		;Clicking orb
        Obj_OgreIH:ChangeCampSpot["-130.366241,-1.860660,-111.528465"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-104.763084,-1.860660,-109.786011"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-95.250328,-1.860667,-111.927559"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-11.339293,-3.235674,-111.856049"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-11.360100,-3.235667,-90.447067"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-14.284431,-3.235661,-77.985710"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-14.543860,-2.630536,-69.203461"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
        ...
        Obj_OgreIH:ChangeCampSpot["-10.710526,-3.235661,-59.889481"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
	...
	{
        echo ${Time}: Moving to Garudon
        Obj_OgreIH:SetCampSpot

		Obj_OgreIH:ChangeCampSpot["-4.464182,-3.235661,-72.453987"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
		Obj_OgreIH:ChangeCampSpot["-11.785773,-3.235667,-89.101921"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
		Mouse:LeftClick
		wait 10

		Obj_OgreIH:ChangeCampSpot["-11.756949,-3.235674,-111.592430"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-73.382408,-1.860673,-111.680191"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10

		Obj_OgreIH:ChangeCampSpot["-73.391930,-2.189308,-84.995918"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		Obj_OgreIH:ChangeCampSpot["-73.735390,-2.946955,-67.665718"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		Obj_OgreIH:ChangeCampSpot["-73.436981,-1.446954,-55.295662"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		...
		call Obj_OgreUtilities.PreCombatBuff 5
		OgreBotAPI:CastAbility_Relay["all","Tortoise Shell"]
		;OgreBotAPI:CastAbility_Relay["all","Stoneskins"]
		
		Obj_OgreIH:ChangeCampSpot["-73.441673,0.645194,-31.337099"]
		call Obj_OgreUtilities.HandleWaitForCampSpot 10
        call Obj_OgreUtilities.HandleWaitForCombat
		eq2execute summon
		wait 10
		
		echo ${Time}: Targeting Garudon
		Ob_AutoTarget:AddActor["${_NamedNPC}",0,FALSE,FALSE]
		wait 10
		call Obj_OgreUtilities.HandleWaitForCombatWithNPC "${_NamedNPC}" 
		eq2execute summon
